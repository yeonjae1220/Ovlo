...
public class ExchangeUniversity {
    ...
    private ExchangeUniversity(ExchangeUniversityId id, String nameKo, String nameEn,
                                String country, String countryCode, String city, String website, Long globalUnivId) {
        this.id = id;
        this.nameKo = nameKo;
        this.nameEn = nameEn;
    ...
    public static ExchangeUniversity restore(Long id, String nameKo, String nameEn,
                                              ...
                                              String city, String website, Long globalUnivId) {
        return new ExchangeUniversity(new ExchangeUniversityId(id), nameKo, nameEn, country, countryCode, city, website, globalUnivId);
    }
